...
func (c *Collector) Collect(dn string) error {
	...
	req := &ldap.SearchRequest{
		...
		DerefAliases: ldap.NeverDerefAliases,
		Filter:       "(objectClass=*)",
		Attributes:   []string{ldapsupport.AttrObjectSid, ldapsupport.AttrSamAccountName, ldapsupport.AttrMember, ldapsupport.AttrPrimaryGroupID, ldapsupport.AttrObjectClass, ldapsupport.AttrNTSecurityDescriptor, ldapsupport.AttrGroupMSAMembership, ldapsupport.AttrSchemaIDGUID, ldapsupport.AttrCN},
